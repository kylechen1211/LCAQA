...
public class page2 extends AppCompatActivity {
    ...
    //private final static String KeyAES = "1234567890123456789012345678901212345678901234567890123456789012";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_encry.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    //KeyAES = "abcdefghijklmnopqrstuvwxyz123456";
        ...
        btn_decry.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                output_p2.setText(copyFromClipboard());
